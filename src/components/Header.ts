      ...
      <nav class="bg-gray-800">
            ...
            <div class="flex items-center">
              ...
              <div class="hidden md:block">
                <div class="ml-10 flex items-baseline space-x-4">
                  ...
                  <a href="./#/404-route" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">404</a>
                </div>
              </div>
            </div>
        ...
        <div class="md:hidden">
          <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <a href="./#/other-route" class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">404</a>
          </div>
        </div>
      </nav>
    </header>
